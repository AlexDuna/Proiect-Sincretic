...
/*
    ...
    Folosind acest algoritm voi oferi utilizatorului sa introduca de la tastatura numarul de linii si coloane ale tablei de sah, respectiv
    N, din cerinta, iar apoi ii voi da oportunitatea de a alege pozitia de plecare.
    Planul este urmatorul: ma voi folosi de 2 vectori pentru pozitiile pe care le poate lua calul pe tabla de sah, unul pentru randuri
